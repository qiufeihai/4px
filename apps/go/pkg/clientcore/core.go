...
func handleSOCKSConn(conn net.Conn, rt *proxyRuntime) {
	...
	req, err := http.NewRequestWithContext(connCtx, http.MethodPost, rt.upstreamURL, pr)
	if err != nil {
...
func openUpstreamTunnel(ctx context.Context, rt *proxyRuntime, target string) (io.ReadCloser, *io.PipeWriter, error) {
